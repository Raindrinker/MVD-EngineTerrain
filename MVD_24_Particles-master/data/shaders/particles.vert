...
void main()
{
    ...
    float r2 = random(vec2(gl_VertexID + 1, u_time*1000.0));
    ...
    if (age > a_life) {
        v_vertex = vec3(0);
        v_velocity = vec3(10*sin(r2*360), 10*r, 10*sin(r*360));
        v_age = u_time;
        v_life = a_life;
    } else {
        v_velocity = a_velocity - vec3(0, 0.001, 0);
        v_vertex = a_vertex + v_velocity*0.001;
        v_age = a_age;
        v_life = a_life;
    }
